...
class model extends connection {
    ...
    public function update($id_skincare, $nm_skincare, $harga, $pembeli, $jml_beli){
        $total = $this->total($harga, $jml_beli);
        $sql = "UPDATE tbl_penjualan SET nm_skincare='$nm_skincare', harga='$harga', pembeli='$pembeli', jml_beli='$jml_beli', diskon='$diskon', '$tot' WHERE id_skincare='$id_skincare'";
        $this->conn->query($sql);
    }
